...
class Statistic(Base):
    ...
    def calculate_statistics(date):
        ...
        statistics = {
            ...
            'n_users_active_in_last_month': n_active_users_in_last_month,
            'n_users_started_conversation': n_users_started_conversation,
            'n_users_did_event': n_users_did_event,
            'n_users_reviewed_event': n_users_reviewed_event,
        }
